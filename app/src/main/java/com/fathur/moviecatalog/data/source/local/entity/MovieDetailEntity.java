...
public class MovieDetailEntity {
    ...
    public MovieDetailEntity(String mvid, String title, String description, String writerfilm, String imagePath, Boolean selectMovie) {
        this.mvid = mvid;
        this.title = title;
