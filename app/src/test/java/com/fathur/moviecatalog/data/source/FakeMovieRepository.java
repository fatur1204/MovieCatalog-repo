...
public class FakeMovieRepository implements MovieDataSource {
    ...
    public FakeMovieRepository(@NonNull RemoteDataSource remoteDataSource, @NonNull LocalDataSource localDataSource, AppExecutors appExecutors) {
        this.remoteDataSource = remoteDataSource;
        this.localDataSource = localDataSource;
        this.appExecutors = appExecutors;
    }

    /*public static FakeMovieRepository getInstance(RemoteDataSource remoteData, LocalDataSource localDataSource, AppExecutors appExecutors) {
        if (INSTANCE == null) {
            synchronized (MovieRepository.class) {
                if (INSTANCE == null) {
                    //INSTANCE = new MovieRepository(remoteData);
                    INSTANCE = new FakeMovieRepository(remoteData, localDataSource, appExecutors);
                }
            }
        }
        return INSTANCE;
